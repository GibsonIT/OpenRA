...
public readonly struct AtomicInt
{
	readonly int num;

	public AtomicInt(int num)
	{
		this.num = num;
	}

	public static AtomicInt operator +(AtomicInt a, AtomicInt b)
	{
		return a;
	}


	public static AtomicInt operator +(AtomicInt a, int b) => new AtomicInt(a.num + b);
	public static AtomicInt operator ++(AtomicInt a) => new AtomicInt(a.num + 1);
	public static AtomicInt operator -(AtomicInt a, AtomicInt b) => new AtomicInt(a.num - b.num);
	public static AtomicInt operator -(AtomicInt a, int b) => new AtomicInt(a.num - b);
	public static AtomicInt operator --(AtomicInt a) => new AtomicInt(a.num - 1);
}
